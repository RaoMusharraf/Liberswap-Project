...
pub mod stablecoin {
	...
	use openbrush::{ contracts::ownable::*, traits::{ Storage, String } };
    ...
    impl STABLECOIN {
        ...
        pub fn new(oracle_address: AccountId) -> Self {
            ...
            instance.metadata.name.set(&Some(String::from("sUSD")));
            instance.metadata.symbol.set(&Some(String::from("sUSD")));
		...
		pub fn get_price_feed(&self, key: String) -> Option<u128> {
			let core::prelude::v1::Some((_feed_time, price_feed)) =
		...
		let _ = psp22::Internal::_mint_to(self, to, value);
		}

		pub fn burn(&mut self, from: AccountId, value: Balance) {
		let _ = psp22::Internal::_burn_from(self, from, value);
		}
		...
		fn _redeem_collateral(&mut self, from: AccountId, amount: Balance) {
			...
			let _ = Self::env().transfer(from, amount);
